...
public class DatePicker extends LinearLayout{
    ...
    ScrollView mView;
    ScrollView mHourView;
    ScrollView mMinuteView;
    ...
    public void changeIndex(ScrollView v, int index){
        if (listener == null) return;
        if (v == mView){
    ...
    private void init(Context context) {
        ...
        mMinuteView = new ScrollView(context, minuteStr);
        ...
        mHourView = new ScrollView(context, hourStr);
        ...
        mView = new ScrollView(context, dateStrList);
