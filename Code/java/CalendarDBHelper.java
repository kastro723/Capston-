...
public class CalendarDBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE todo (_id INTEGER PRIMARY KEY AUTOINCREMENT," +
                " title TEXT, color TEXT, startAttr INTEGER, endAttr INTEGER)");
    }
    ...
    public ArrayList<DateEvent> Loading() {
        ...
        if (cursor.getCount() != 0) {
            ...
            while (cursor.moveToNext()){
                ...
                DateEvent e2 = new DateEvent(title, c, startAttr, endAttr);
    ...
    public void InsertTodo(String title, String color, long startAttr, long endAttr){
        SQLiteDatabase db = getWritableDatabase();
        db.execSQL("INSERT INTO todo (title, color, startAttr, endAttr) VALUES('" + title + "','" +
